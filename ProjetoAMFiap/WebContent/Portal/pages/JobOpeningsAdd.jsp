                        ...
                        <form class="sample-form" method="post" action="">
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="jobTitle">Job
                                        Title</label>
                                    <input id="jobTitle" class="form-control" type="text" name="jobTitle" required>
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="reportsTo">Reports To</label>
                                    <input id="reportsTo" class="form-control" type="text" name="reportsTo" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <label for="sector" class="control-label">Sector</label>
                                    <select name="sector" class="form-control input-sm select2-single" id="sector">
                                        <option value=""></option>
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="experienceLevel" class="form-control select2-single"
                                        id="experienceLevel">
                                        <option></option>
                                        <option value=""></option>
                                        <option value=""></option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <textarea class="form-control" name="jobOverview" id="jobOverview" rows="5"
                                        required></textarea>
                                </div>
                                <div class="form-group col-6 col-md-4">
                                    <label for="responsibilities">Responsibilities and Duties:</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control select2-single" id="city">
                                        <option value=""></option>
                                        <option value=""></option>
                                        <option value=""></option>
                                    </select>
