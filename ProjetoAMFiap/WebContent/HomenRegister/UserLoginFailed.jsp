        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-8">
          <div class="card w-100 mx-auto">
            <div class="col-10 card-body align-self-center">
              ...
              <hr>
              <p class="text-success text-center" style="color:red;font-size:22px;">Login email or password wrong!</p>
  ...
  <footer id="sticky-footer" class="footer bg-dark text-white-50">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-4">
          <small><span class="copyright">Copyright &copy; Sniper Contractor Inc. 2019</span></small>
        </div>
        <div class="col-4">
