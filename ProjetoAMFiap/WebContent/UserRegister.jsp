...
<title>Sniper Contractor - User Register</title>
...
<div class="background"></div>
	<div class="container">
		<div class="inner-container">
			<h1>What about stop wasting time and register to search better opportunities?</h1>
			<div class="box">
				<form action="userregister" method="POST">
					...
					<div class="inputBox">
						<label style="margin-left:30px;">Phone:</label> <input type="text" name="phone"
							placeholder="Enter phone here..." required><br />
						<br />
					</div>
					<div class="inputBox">
				...
				<br />
				<br /> <a href="EmployeeRegister.jsp">Recruiters Register
					(Administrator Password Required)</a>
